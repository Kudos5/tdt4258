...
extern uint16_t seq_counter;          // Simulates sequencer timer clock
extern uint16_t aud_counter;          // Simulates audio timer clock
...
extern volatile uint16_t* TIMER_AUD_CNT;
extern volatile uint16_t* TIMER_SEQ_CNT;
