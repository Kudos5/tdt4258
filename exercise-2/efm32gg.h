...
#define GPIO_EXTIPSELL ((volatile uint32_t*)(GPIO_BASE + 0x00))
#define GPIO_EXTIPSELH ((volatile uint32_t*)(GPIO_BASE + 0x04))
#define GPIO_EXTIRISE  ((volatile uint32_t*)(GPIO_BASE + 0x08))
#define GPIO_EXTIFALL  ((volatile uint32_t*)(GPIO_BASE + 0x0c))
#define GPIO_IEN       ((volatile uint32_t*)(GPIO_BASE + 0x10))
...
#define DAC_CHCTRL_PRSSEL_MASK  (0xF << DAC_CHCTRL_PRSSEL_POS)
