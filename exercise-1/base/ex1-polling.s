...
//
// Polling procedure
// Detect button presses by Continuously polling for changes in pin state
//
/////////////////////////////////////////////////////////////////////////////
...
.thumb_func
poll_buttons:
    // Load gamepad input register from memory
    ldr r0, =GPIO_PC_BASE
    ldr r1, [r0, GPIO_DIN]

    // Continue only if there was a change in state.
    // Previous state is stored in r3
    cmp r1, r3
    itt eq
    moveq r3, r1
    beq poll_buttons
...
//
// Setup 
// Enable GPIO (and make a dummy handler that does nothing)
//
/////////////////////////////////////////////////////////////////////////////
